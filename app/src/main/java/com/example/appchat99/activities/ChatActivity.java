...
import com.example.appchat99.adapters.ChatAdapter;
import com.example.appchat99.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void updateConversion(String message){
        DocumentReference documentReference=
                database.collection(Constants.KEY_COLLECT_CONVERSATIONS).document(conversionId);
